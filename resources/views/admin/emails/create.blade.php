        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.emails.store") }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('email_contact') ? 'is-invalid' : '' }}" type="email" name="email_contact" id="email_contact" value="{{ old('email_contact') }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('industries') ? 'is-invalid' : '' }}" type="text" name="industries" id="industries" value="{{ old('industries', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('area_code') ? 'is-invalid' : '' }}" type="text" name="area_code" id="area_code" value="{{ old('area_code', '') }}">

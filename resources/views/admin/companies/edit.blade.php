        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.companies.update", [$company->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control {{ $errors->has('company_details') ? 'is-invalid' : '' }}" name="company_details" id="company_details">{{ old('company_details', $company->company_details) }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('company_type') ? 'is-invalid' : '' }}" name="company_type" id="company_type" required>
                        ...
                        @foreach(App\Models\Company::COMPANY_TYPE_SELECT as $key => $label)
                            <option value="{{ $key }}" {{ old('company_type', $company->company_type) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('founded') ? 'is-invalid' : '' }}" type="text" name="founded" id="founded" value="{{ old('founded', $company->founded) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('employees') ? 'is-invalid' : '' }}" type="text" name="employees" id="employees" value="{{ old('employees', $company->employees) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('revenue') ? 'is-invalid' : '' }}" type="text" name="revenue" id="revenue" value="{{ old('revenue', $company->revenue) }}">
